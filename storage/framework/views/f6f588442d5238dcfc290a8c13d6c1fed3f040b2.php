...
<div class="modal fade" id="modal-create" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <form id="formData" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select name="kategori" id="kategori" class="form-select" required>
                            ...
                            <option value="Laki-Laki">Indoor</option>
                            <option value="Perempuan">Outdoor</option>
                        </select>
                        <div class="alert alert-danger mt-2 d-none" role="alert" id="alert-nama"></div>
                    </div>
                    <div class="form-group">
    ...
    $('#store').click(function(e) {
        ...
        //ajax
        $.ajax({
            url: '<?php echo e(url('api/barangs')); ?>',
            type: "POST",
            data: data,
            cache: false,
            dataType: 'json',
            ...
            success:function(response){
                ...
                let barang = `
                    <tr id="index_${response.data.id}">
                        ...
                        <td><img src="<?php echo e(url('storage/storage/gambar/')); ?>${"/"+response.data.gambar}"  style="width: 100px; height:100px"></td>
    ...
    </script><?php /**PATH C:\xampp\htdocs\projectWPF\resources\views/barang/modal-create.blade.php ENDPATH**/ ?>