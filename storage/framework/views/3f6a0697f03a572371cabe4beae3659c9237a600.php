            ...
            <div class="modal-body">
                <form id="formData _edit" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="kategori-edit" name="kategori-edit">
...
$('body').on('click', '#btn-edit-post', function () {
    ...
    $.ajax({
        url: '<?php echo e(url('api/barangs')); ?>/'+post_id,
        type: "GET",
        cache: false,
    ...
    $.ajax({
        ...
        success:function(response){
            ...
            <tr id="index_${response.data.id}">
                ...
                <td>
                    <img src="<?php echo e(url('storage/storage/gambar/')); ?>${"/"+response.data.gambar}" width=100 height=100>
                </td>
...
</script><?php /**PATH C:\xampp\htdocs\projectWPF\resources\views/barang/update.blade.php ENDPATH**/ ?>