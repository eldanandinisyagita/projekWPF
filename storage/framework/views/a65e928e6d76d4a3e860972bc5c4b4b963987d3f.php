...
-->
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-1 my-1" ><?php echo $__env->yieldContent('judul_header'); ?>
									<!--begin::Separator-->
								...
								<div class="d-flex align-items-center py-1">
									<?php echo $__env->yieldContent('button_header'); ?>
									<!--begin::Wrapper-->
	...
	<!--end::Body-->
<svg id="SvgjsSvg1001" width="2" height="0" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev" style="overflow: hidden; top: -100%; left: -100%; position: absolute; opacity: 0;"><defs id="SvgjsDefs1002"></defs><polyline id="SvgjsPolyline1003" points="0,0"></polyline><path id="SvgjsPath1004" d="M-1 150L-1 150C-1 150 187.6 150 187.6 150C187.6 150 375.2 150 375.2 150C375.2 150 562.8 150 562.8 150C562.8 150 750.4 150 750.4 150C750.4 150 938 150 938 150C938 150 938 150 938 150 "></path></svg></body></html><?php /**PATH C:\xampp\htdocs\projectWPF\resources\views/layouts/main.blade.php ENDPATH**/ ?>