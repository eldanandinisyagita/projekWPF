...
<div class="modal fade" id="modal-create" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <form id="formData" enctype="multipart/form-data" method="post">
                    <div class="form-group">
                        ...
                        <select name="id_ba rangs" id="id_barangs" class="form-select" required>
                           <?php $__currentLoopData = $barangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $barang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option selected="selected"  value="<?php echo e($barang->id); ?>"><?php echo e($barang->nama); ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_customers" id="id_customers" class="form-select" required>
                           <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option selected="selected"  value="<?php echo e($customer->id); ?>"><?php echo e($customer->nama_customer); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <div class="alert alert-danger mt-2 d-none" role="alert" id="alert-nama"></div>
                    </div>
    ...
    $('#store').click(function(e) {
        ...
        //ajax
        $.ajax({
            url: '<?php echo e(url('api/brg_keluars')); ?>',
            type: "POST",
            data: data,
            cache: false,
            dataType: 'json',
    ...
    </script><?php /**PATH C:\xampp\htdocs\projectWPF\resources\views/brg_keluar/modal-create.blade.php ENDPATH**/ ?>