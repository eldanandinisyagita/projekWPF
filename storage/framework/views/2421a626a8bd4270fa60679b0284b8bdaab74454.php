...
<?php $__env->stopSection(); ?>
<?php $__env->startSection('judul_header', 'Data Barang'); ?>
                        ...
                        <div class="card border-0 shadow-sm rounded-md mt-4">
                            <div class="card-body">
                                ...
                                <tbody id="table-barangs">
                                    ...
                                    <td style="padding-left:10px"><?php echo e($barang->nama); ?></td>
                                    <td><?php echo e($barang->kategori); ?></td>
                                    <td><?php echo e($barang->stok); ?></td>
                                    <td><?php echo e($barang->deskripsi); ?></td>
                                    <td><img src="<?php echo e(url('/storage/storage/gambar/'.$barang->gambar)); ?>" width="100" height="100"/></td>
                                    <td>Rp. <?php echo e($barang->harga); ?></td>
                                    <td class="text-center" style="padding-right:10px"> <a href="javascript:void(0)" id="btn-edit-post" data-id="<?php echo e($barang->id); ?>" class="btn btn-primary btn-sm">EDIT</a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projectWPF\resources\views/barang/list-barang.blade.php ENDPATH**/ ?>